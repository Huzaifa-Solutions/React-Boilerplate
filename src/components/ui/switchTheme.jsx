      ...
      <div className="flex items-center">
        ...
        >
          <span className="relative mx-3">
            ...
            <input
              id="theme"
              className="peer relative z-10 block w-14 h-7 appearance-none rounded-full transition-all duration-300 ease-in-out cursor-pointer
              bg-[hsl(249,73%,27%)] shadow-[0_0_0_0.125em_rgba(0,0,0,0.1)]
              before:block before:w-5 before:h-5 before:rounded-full before:transition-all before:duration-300 before:content-['']
            ...
            <span className="absolute top-1 left-1.5 block w-5 h-5 z-10 transition-transform duration-300 peer-checked:translate-x-6 pointer-events-none">
